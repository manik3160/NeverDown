...
from api.routes import auth, health, incidents, integrations, live, status, webhooks
...
def create_app() -> FastAPI:
    ...
    app.include_router(integrations.router, prefix=settings.API_PREFIX + "/integrations", tags=["Integrations"])
